                    ...
                    <div className="flex-1">
                      ...
                      <blockquote className="flex-1 mt-8">
                        <p className="text-lg leading-relaxed text-gray-900 font-pj">
                          ...
                          adipisicing elit. Consectetur pariatur expedita sit
                          modi ab atque incidunt dolorem esse recusandae
                          quos.&#34;
                        </p>
                      </blockquote>
                    </div>
                  ...
                  <div className="flex flex-col justify-between flex-1 p-6 bg-white lg:py-8 lg:px-7">
                    <div className="flex-1">
                      ...
                      <blockquote className="flex-1 mt-8">
                        <p className="text-lg leading-relaxed text-gray-900 font-pj">
                          &#34;Lorem ipsum dolor sit amet consectetur,
                          adipisicing elit. Tenetur exercitationem expedita at
                          labore sed libero consequuntur minima iure qui
                          recusandae!&#34;
                        </p>
                      </blockquote>
                    </div>
                  ...
                  <div className="flex flex-col justify-between flex-1 p-6 bg-white lg:py-8 lg:px-7">
                    <div className="flex-1">
                      ...
                      <blockquote className="flex-1 mt-8">
                        <p className="text-lg leading-relaxed text-gray-900 font-pj">
                          &#34;Lorem ipsum, dolor sit amet consectetur
                          adipisicing elit. Quas illum nobis praesentium placeat
                          ullam quo nesciunt quaerat quam facere minima?&#34;
                        </p>
                      </blockquote>
                    </div>
